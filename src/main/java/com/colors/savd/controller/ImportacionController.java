...
public class ImportacionController {
    ...
    */
    ...
    public ImportResultadoDTO importarVentasExcel(@RequestPart("file") MultipartFile file, @RequestParam("usuarioId") Long usuarioId) throws Exception {
        ...
        try(var in = file.getInputStream()){
            return importacionService.importarVentasExcel(in, nombre, usuarioId);
        }
    }
}
